...
//
//
// $Id: GD.php 7184 2011-07-20 19:11:50Z calguy1000 $
//
...
Class Image_Transform_Driver_GD extends Image_Transform
{
    ...
    */
	...
	function resizeANDcrop_circle($new_x, $new_y){
		...
		imagefilledellipse($img2, ($new_x/2), ($new_y/2), $new_x, $new_y, $e); 
		
		imagecolortransparent($img2, $e);

		imagecopymerge($img1, $img2, 0, 0, 0, 0, $new_x, $new_y, 100);
		//$bg2 = imagecolorallocatealpha($img1, 255, 255, 255, 0);
		
		$bg2 = imagecolorallocate($img1, 255, 255, 255);
		imagecolortransparent($img1, $bg2);
		
		//header("Content-type: image/png");
		//imagepng($img1); die;
		
		$this->imageHandle = $img1;
	}
