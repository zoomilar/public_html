...
#
#$Id: index.php 8573 2012-12-15 16:23:17Z calguy1000 $


//lt/kainos/

$kintamasis  = $_SERVER["REQUEST_URI"];
$qurid["/palanges-kambariuose/"] = "palanges.html";
$qurid["/spalvos-ir-dydziai/"] = "palanges.html";
$qurid["/spalvos-ir-dydziai1/"] = "palanges.html";
$qurid["/terasos-irengimas/"] = "terasu-lentos.html";
$qurid["/spalvos-ir-dydziai-2/"] = "terasu-lentos.html";
$qurid["/verta-zinoti/"] = "terasu-lentos.html";
$qurid["/fasadu-apdailos-pavyzdziai/"] = "namo-fasadai.html";
$qurid["/spalvos-ir-dydziai-3/"] = "namo-fasadai.html";
$qurid["/verta-zinoti-2/"] = "namo-fasadai.html";
$qurid["/pvc-dailylentes/"] = "namo-fasadai.html";
$qurid["/sviestuvai-namuose/"] = "sviestuvai.html";
$qurid["/dizainas-ir-priedai/"] = "sviestuvai.html";
$qurid["/verta-zinoti-3/"] = "sviestuvai.html";
$qurid["/orlaides-namuose/"] = "orlaides-tinkleliai-langams.html";
$qurid["/spalvos-ir-dydziai-4/"] = "orlaides-tinkleliai-langams.html";
$qurid["/verta-zinoti-4/"] = "orlaides-tinkleliai-langams.html";
$qurid["/spalvos-ir-dydziai-5/"] = "tinkleliai.html";
$qurid["/spalvos-ir-dydziai-6/"] = "vidaus-apdaila-sienu-ir-lubu.html";
$qurid["/namu-apdailos-juostos-angokrasciai/"] = "langu-apdailos-juostos-ir-angokrasciai.html";
$qurid["/spalvos-ir-dydziai-7/"] = "langu-apdailos-juostos-ir-angokrasciai.html";
$qurid["/verta-zinoti-7/"] = "langu-apdailos-juostos-ir-angokrasciai.html";


$kint = explode("/",$kintamasis);


if ($qurid[$kintamasis]!="") {
 header("HTTP/1.0 301 Moved Permanently");  
 header("Location: http://{$_SERVER['SERVER_NAME']}/{$qurid[$kintamasis]}");
 exit;
 }
...
try {
  ...
  if($isTablet == false && $isMobile == true){
	  if ($_GET["user_agent"] != 'desktop' && $_SESSION['desktop_session'] != 1){
	  	$user_agent = 'mob';
	  }else{
	  	session_start();
		$_SESSION['desktop_session'] = 1;
	  };
	  
	  if ($_GET["user_agent"] == 'mobile' && $_SESSION['desktop_session'] == 1){
	  	$user_agent = 'mob';
		session_start();
		$_SESSION['desktop_session'] = 0;
	  }
  }

  $smarty->assign('user_agent', $user_agent);
  $smarty->assign('desktop_session', $_SESSION['desktop_session']);	
