...
<ul>
  ...
  <li>breadcrumbs - Utilizzato per creare l&#039;indicazione di percorso alla pagina visualizzata.  <strong>Nota: {cms_breadcrumbs}</strong> &egrave; un&#039;abbreviazione per per richiamare questa zione.</li>
</ul>';
...
$lang['help_childrenof'] = 'Con questa opzione il menu visualizzer&agrave; solo gli elementi di livello superiore all&#039;ID di pagina o alias selezionato. Ad es.: <code>{menu childrenof=$page_alias}</code> visualizzer&agrave; solo le pagine figlio di quella corrente.';
$lang['usage'] = 'Utilizzo';
$lang['import'] = 'Importa';
$lang['edit'] = 'Modifica';
$lang['delete'] = 'Elimina';
