{$formstart}
<p>{$mod->Lang('info_std_auth_settings')}</p>
<fieldset>
...
<div class="pageoverflow">
  <p class="pagetext">{$mod->Lang('prompt_usecookiestoremember')}:</p>
  <p class="pageinput">
   {cge_yesno_options prefix=$actionid name=usecookiestoremember selected=$usecookiestoremember}
   <br/>
   {$mod->Lang('info_cookiestoremember')}
  </p>
</div>
<div class="pageoverflow">
  <p class="pagetext">{$mod->Lang('prompt_cookiename')}:</p>
  <p class="pageinput">
   <input type="text" name="{$actionid}cookiename" value="{$cookiename}"/>
  </p>
</div>
<div class="pageoverflow">
