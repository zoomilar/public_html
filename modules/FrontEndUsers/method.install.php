...
$fn = cms_join_path(dirname(__FILE__),'templates','orig_lostunform_template.tpl');
if( file_exists( $fn ) )
  {
...
$fn = cms_join_path(dirname(__FILE__),'templates','orig_notification_template.tpl');
if( file_exists( $fn ) )
  {
    $template = @file_get_contents($fn);
...
$fn = cms_join_path(dirname(__FILE__),'templates','orig_viewuser_template.tpl');
if( file_exists( $fn ) )
  {
    $template = @file_get_contents($fn);
...
if( file_exists( $fn ) )
  {
    ...
    $this->SetPreference('usecookiestoremember',0);
