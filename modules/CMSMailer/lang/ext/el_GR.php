<?php
$lang['sendtestmailconfirm'] = 'Θα αποσταλλεί ενα δοκιμαστικό μήνυμα στην προκαθορισμένη διεύθυνση. Αν η διαδικασία αποστολής είναι επιτυχής, Θα επιστρέψετε σε αυτήν την σελίδα.  Θέλετε να συνεχίσετε?';
