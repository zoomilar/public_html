<?php
$lang['sendtestmailconfirm'] = 'Hiermit versenden Sie eine Testnachricht an eine festgelegte Adresse. Wenn der Versand erfolgreich war, kehren Sie zu dieser Seite zur&uuml;ck. Wollen Sie fortfahren?';
$lang['settingsconfirm'] = 'Sollen die aktuellen Werte in die CMSMailer-Einstellungen geschrieben werden?';
...
$lang['info_from'] = 'Email-Adresse, die als Absender f&uuml;r alle Emails genutzt werden soll';
$lang['info_fromuser'] = 'Realname, der als Absender f&uuml;r alle Emails genutzt werden soll';
$lang['info_sendmail'] = 'Der komplette Pfad zu Ihrem sendmail-Programm (nur f&uuml;r die SMTP-Mailmethode g&uuml;ltig)';
$lang['info_timeout'] = 'Dauer der SMTP-Konversation in Sekunden, bevor eine Fehlermeldung erscheint (nur f&uuml;r die SMTP-Mailmethode g&uuml;ltig)';
