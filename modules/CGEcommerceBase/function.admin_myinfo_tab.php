...
//
$smarty->assign('formstart',$this->CGCreateFormStart($id,'admin_save_myinfo'));
$smarty->assign('formend',$this->CreateFormEnd());
$smarty->assign('my_address',$my_address);
$state_list = cge_array::hash_prepend($this->get_state_list_options(),'-1',$this->Lang('not_applicable'));
