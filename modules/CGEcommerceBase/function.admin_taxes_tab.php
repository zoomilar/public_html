...
$tmp = module_helper::get_modules_with_method('GetTaxesForProduct');
$module_list = cge_array::hash_prepend($tmp,-1,$this->Lang('none'));
$smarty->assign('tax_modules',$module_list);
$smarty->assign('tax_module',$this->GetPreference('tax_module',-1));
$smarty->assign('tax_shipping',$this->GetPreference('tax_shipping',1));
echo $this->ProcessTemplate('admin_taxes_tab.tpl');
#
# EOF
#
?>