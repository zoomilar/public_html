...
$module_list = module_helper::get_modules_with_method('IsCartModule');
$module_list = cge_array::hash_prepend($module_list,-1,$this->Lang('none'));
$smarty->assign('cart_modules',$module_list);
$smarty->assign('cart_module',$this->GetPreference('cart_module',-1));

echo $this->ProcessTemplate('admin_cart_tab.tpl');
#
# EOF
#
?>