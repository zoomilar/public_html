...
// events
$this->RemoveEvent('CartItemAddPre');
$this->RemoveEvent('CartAdjusted');
$this->RemoveEvent('CartItemAdded');
$this->RemoveEvent('OrderCreated');
$this->RemoveEvent('OrderUpdated');
$this->RemoveEvent('OrderDeleted');
