...
if( isset($params['submit']) )
  {
    $address = new cg_ecomm_company_address();
    $address->from_array($params,'');
    if( !$address->is_valid() )
      {
	$this->SetError($this->Lang('error_invalidaddress'));
      }
    else
      {
	$this->SetPreference('myinfo_address',serialize($address));
      }
  }
