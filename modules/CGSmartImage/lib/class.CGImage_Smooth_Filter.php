...
/**
 * Smoothing Image image filter class
 * 
 * Performs a smoothing filter on the supplied image.
 *
 * @author Robert Campbell <calguy1000@cmsmadesimple.org>
 * @package CGSmartImage
 */
class CGImage_Smooth_Filter extends CGImageFilterBase
{
  /**
   * The Smoothing Sice
   * @access private
   ...
   * Constructor.
   *
   * This method accepts a variety of ways of specifying the smoothness factor.
   * i.e:  $obj = new CGImage_Smooth_Filter(3);
   * i.e:  $obj = new CGImage_Smooth_Filter(array(3));
   */
  ...
  public function transform(CGImageBase $src)
  {
    ...
    $res = imagefilter($_dest['rsrc'],IMG_FILTER_SMOOTH,$this->_smooth);

    if( !$res )
      {
	throw new Exception('Error applying filter '.IMG_FILTER_SMOOTH);
      }
    return $_dest;
  }
}
