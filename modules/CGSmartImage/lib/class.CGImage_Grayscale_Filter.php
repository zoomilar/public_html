...
class CGImage_Grayscale_Filter extends CGImageFilterBase
{
  ...
  public function transform(CGImageBase $src)
  {
    ...
    $res = imagefilter($_dest['rsrc'],IMG_FILTER_GRAYSCALE);

    if( !$res )
      {
	throw new Exception('Error applying filter '.IMG_FILTER_GRAYSCALE);
      }
    return $_dest;
  }
}
