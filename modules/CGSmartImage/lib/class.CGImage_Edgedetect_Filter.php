...
class CGImage_Edgedetect_Filter extends CGImageFilterBase
{
  ...
  public function transform(CGImageBase $src)
  {
    ...
    $res = imagefilter($_dest['rsrc'],IMG_FILTER_EDGEDETECT);

    if( !$res )
      {
	throw new Exception('Error applying filter '.IMG_FILTER_EDGEDETECT);
      }
    return $_dest;
  }
}
