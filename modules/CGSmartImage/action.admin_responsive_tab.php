...
$this->SetCurrentTab('responsive');

$this->SetPreference('responsive',(int)$params['responsive']);
$this->SetPreference('responsive_breakpoints',trim($params['responsive_breakpoints']));
