...
switch($current_version)
{
 ...
 case "1.7":
 case "1.8":
	// here's an example -- we expand the Languages database record to include another field.
	$db = $gCms->GetDb();
	$dict = NewDataDictionary( $db );
	$sqlarray = $dict->AddColumnSQL(cms_db_prefix()."module_languages", "explanation X");
