...
$smarty->assign('input_thumbnailsize',
		$this->CreateInputText($id,'thumbnailsize',
				       $this->GetPreference('thumbnailsize'),3,3));
$smarty->assign('prompt_imageextensions',
		$this->Lang('image_extensions'));
$smarty->assign('input_imageextensions',
		$this->CreateInputText($id,'imageextensions',
				       $this->GetPreference('imageextensions',''),25,255));
$smarty->assign('input_allow_watermarking',
		$this->CreateInputYesNoDropdown($id,'allow_watermarking',
						$this->GetPreference('allow_watermarking',0)));
$smarty->assign('input_allow_thumbnailing',
		$this->CreateInputYesNoDropdown($id,'allow_thumbnailing',
						$this->GetPreference('allow_thumbnailing',0)));
$smarty->assign('input_allow_resizing',
		$this->CreateInputYesNoDropdown($id,'allow_resizing',
						$this->GetPreference('allow_resizing',0)));
$smarty->assign('input_resizeimage',
		$this->CreateInputText($id,'resizeimage',
				       $this->GetPreference('resizeimage'),3,3));
