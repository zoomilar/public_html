<?php
	...
	$dest = "Location: ".'/uploads/images/catalog/'.$spec.'.jpg';
    ...
    function imageTransform($srcSpec, $destSpec, $size, &$config, $aspect_ratio='')
    {
		...
		if ($size == 400)
			$img->resizeANDcenter(600, 325, 1, "208,208,208");
			
		if ($size == 30)
			$img->resizeANDcrop(460, 159);			
		
		if ($size == 70)
			$img->resizeANDcrop(600, 325);		
			
			
			
		
     
        $img->save($destSpec, 'png');
