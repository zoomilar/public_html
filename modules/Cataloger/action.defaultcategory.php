<?php
  ...
  for ($i=1; $i<=$imgcount; $i++)
  {
    ...
    array_push($thumbArray, $this->imageSpec($curPage->Alias(), 'ct', $i, $thumbSize));	
		array_push($srcImgArray, $this->srcImageSpec($curPage->Alias(), $i));
