<?php
$lang['nameimages'] = 'Изображения';
$lang['deleteimage'] = 'Удалить изображение';
$lang['Owner'] = 'Владелец';
$lang['CatalogItem'] = 'Классификатор элементов';
$lang['namepage'] = 'Страница';
$lang['Permissions'] = 'Разрешения';
$lang['Sub'] = 'Подкатегории - ';
$lang['title_global_item_sort_order2'] = 'Порядок сортировки элементов';
$lang['title_global_items_per_page2'] = 'Элементов на страницу';
$lang['title_global_category_recurse2'] = 'Монитор поведения';
$lang['which_attributes'] = 'Какие атрибуты должны быть указаны в каталоге';
$lang['navTab'] = ' |  ';
$lang['needpermission'] = 'Вам необходимо %s установить для этого';
$lang['friendlyname'] = 'Классификатор';
$lang['admindescription'] = 'Управление настройками каталога';
$lang['areyousure'] = 'Вы уверены, что хотите удалить %s?';
$lang['uniquecode'] = 'Уникальный код';
$lang['templatelist'] = 'Шаблон подкатегорий';
$lang['listtempl'] = 'Управление шаблонами подкатегорий';
$lang['title_item_tab'] = 'Атрибуты элемента';
$lang['title_category_tab'] = 'Атрибуты категории';
$lang['title_printable_tab'] = 'Настройки печати';
$lang['title_item_image_tab'] = 'Размер изображения элемента';
$lang['title_category_image_tab'] = 'Настройки страницы категории';
$lang['title_is_textfield'] = 'Текстовое поле?';
$lang['title_delete'] = 'Удалить?';
$lang['title_aspect_tab'] = 'Пропорции изображения';
$lang['title_image_tab'] = 'Другие настройки изображений';
$lang['title_item_template_vars'] = 'Переменные шаблона элемента';
$lang['title_cat_template_vars'] = 'Переменные шаблона категории';
$lang['title_feature_template_vars'] = 'Переменные шаблона характеристик';
$lang['title_show_only_existing_images'] = 'Не выводить отсутствующие изображения';
...
$lang['cataloger'] = 'Классификатор';
$lang['item_page'] = 'Страница Элемента';
$lang['category_page'] = 'Страница Категории';
$lang['catalog_printable'] = 'Каталог для печати';
$lang['catalog_datasheet'] = 'Каталог спецификации';
$lang['catalog_short_list'] = 'Список компонентов';
$lang['title_global_item_sort_order'] = 'Установить сортировку элементов по';
$lang['title_global_items_per_page'] = 'Установить количество элементов на странице';
$lang['title_global_category_recurse'] = 'Set Category Display Behavior to';
$lang['title_item_sort_order'] = 'Сортировка элементов по умолчанию';
$lang['title_printable_sort_order'] = 'Default printable catalog sort order';
$lang['title_items_per_page'] = 'Количество элементов на странице по умолчанию';
$lang['title_avail_attrs'] = 'Атрибуты элемента доступные для шаблона';
$lang['title_avail_imattrs'] = 'Изображения элемента доступные для шаблона';
...
$lang['title_template_type'] = 'Тип Шаблона';
$lang['title_title'] = 'Название';
...
$lang['title_item_attributes_help'] = 'Каждый атрибут введённый здесь будет названием поля, которое можно использовать для описания отдельного элемента, и будут показаны вместе с ним. Возможно, вам придется обновить свой шаблон, чтобы отобразить эти атрибуты.';
$lang['title_category_attributes_help'] = 'Каждый атрибут введённый здесь будет названием места, которое можно использовать для описания категории, и будет показано на странице этой категории. Возможно, вам придется обновить свой шаблон, чтобы отобразить эти атрибуты.';
$lang['title_catalog_attributes_help'] = 'Каждый атрибут введённый здесь будет названием места, которое можно использовать для описания всего каталога, который будет отображаться на странице каталога печати. Возможно, вам придется обновлять свой шаблон, чтобы отобразить эти атрибуты.';
...
$lang['title_category_recurse_items_all'] = 'Включить все элементы в рамках данной категории, в том числе элементы в подкатегории';
$lang['title_category_recurse_items_one'] = 'Включить все элементы непосредственно этой категории, но не элементы в подкатегории';
$lang['title_category_recurse_categories_all'] = 'Включение всех категорий в рамках этой категории, в том числе в категории подкатегории';
$lang['title_category_recurse_categories_one'] = 'Включение всех категорий непосредствено этой категории, но не включая категории подкатегории';
$lang['title_category_recurse_mixed_all'] = 'Включить все элементы и категории в этой категории, в том числе элементы и категории в подкатегории';
$lang['title_category_recurse_mixed_one'] = 'Включить все элементы и категории непосредственно этой категории, но не элементы или категорий в подкатегории';
$lang['title_show_missing_images'] = 'Показывать "No Image" для отсутсвующих изображений';
...
$lang['manageprefs'] = 'Настройки';
$lang['manageattrs'] = 'Управление Атрибутами';
$lang['globalops'] = 'Общии операции с каталогом';
$lang['addtemplate'] = 'Добавить шаблон';
$lang['reimporttemplates'] = 'Вернуть демонстрационные шаблоны';
$lang['reimported'] = 'Демонстрационные шаблоны подкатегорий успешно импортированы';
$lang['templateupdated'] = 'Шаблон добавлен / обновлён';
$lang['templatedeleted'] = 'Шаблон удален';
$lang['prefsupdated'] = 'Настройки обновлены';
$lang['installed'] = 'Модуль версии %s установлен';
$lang['upgraded'] = 'Модуль обновлен до версии %s.';
$lang['uninstalled'] = 'Модуль удален';
$lang['attrsupdated'] = 'Атрибуты обновлены';
$lang['noglobalchange'] = '<Не выбрано>';
$lang['globallyupdated'] = 'Изменения распространяются на глобальном уровне';
$lang['edittemplate'] = 'Изменить шаблон';
$lang['subtemplates'] = 'Каталог шаблонов подкатегорий';
$lang['next'] = ':»';
$lang['prev'] = '«:';
$lang['edit'] = 'Редактировать';
$lang['delete'] = 'Удалить';
$lang['notemplates'] = 'Нет установленных шаблонов подкатегорий';
...
$lang['postinstall'] = 'Убедитесь в том, чтобы были установленны права на "Изменение настройки каталога" для пользователей, которые будут управлять каталогом.';
$lang['utmz'] = '156861353.1237555608.29.24.utmccn=(referral)|utmcsr=forum.cmsmadesimple.org|utmcct=/index.php/topic,27626.0.html|utmcmd=referral';
$lang['utma'] = '156861353.1512485689.1236874721.1237555608.1237558117.30';
$lang['utmc'] = '156861353';
$lang['utmb'] = '156861353';
?>