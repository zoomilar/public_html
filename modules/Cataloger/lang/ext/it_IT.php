<?php
$lang['nameimages'] = 'Immagini';
$lang['deleteimage'] = 'Cancella Immagini';
$lang['Owner'] = 'Proprietario';
$lang['CatalogItem'] = 'Item di Cataloger';
$lang['namepage'] = 'Pagina';
$lang['Permissions'] = 'Permessi';
$lang['Sub'] = 'Sotto -';
$lang['title_global_item_sort_order2'] = 'Ordine per gli Item';
$lang['title_global_items_per_page2'] = 'Items per Pagina';
$lang['title_global_category_recurse2'] = 'Comportamento di visualizzazione';
$lang['which_attributes'] = 'Quale attributi dovrebbero essere mostrati in catalog';
$lang['navTab'] = ' | ';
$lang['needpermission'] = 'Devi configurare %s per fare questo.';
$lang['friendlyname'] = 'Cataloger';
$lang['admindescription'] = 'Configurazioni Catalogo';
$lang['areyousure'] = 'Sei sicuro che vuoi cancellare questo %s?';
$lang['uniquecode'] = 'Codice unico';
$lang['templatelist'] = 'Sotto-Modelli';
$lang['listtempl'] = 'Gestione Sotto-Modelli';
$lang['title_item_tab'] = 'Attributi articolo';
$lang['title_category_tab'] = 'Attributi categoria';
$lang['title_printable_tab'] = 'Configurazioni catalogo stampabile';
$lang['title_item_image_tab'] = 'Dimensioni immagine articolo';
$lang['title_category_image_tab'] = 'Configurazioni pagina categorie';
$lang['title_is_textfield'] = 'Text Area?';
$lang['title_delete'] = 'Cancella?';
$lang['title_aspect_tab'] = 'Rapporto delle dimensioni immagine';
$lang['title_image_tab'] = 'Altre configurazioni delle immagini';
$lang['title_item_template_vars'] = 'Variabili Modello articolo';
$lang['title_cat_template_vars'] = 'Variabili Modello categoria';
$lang['title_feature_template_vars'] = 'Variabili Modello feature';
$lang['title_show_only_existing_images'] = 'Non include immagini vuote';
$lang['title_show_only_existing_images_help'] = 'Questo metter&agrave; riferimenti di immagini in liste se l&#039;mmagine esiste.<br />(Normalmente, va bene, ma se volete fare qualcos&#039;altro con gli indici<br />di array di immagini, questo pu&ograve; comportare problemi.)';
$lang['title_flush_cats'] = 'Svuota i buffer della pagina categoria';
$lang['title_flush_cats_help'] = 'Se avete un numero elevato di item da visualizzare<br />in una categoria, alcune installazione di PHP falliscono<br />di visualizzare la pagina correttamente. Check questo box per risolvre il problema (test per gli effetti).';
$lang['cataloger'] = 'Cataloger';
$lang['item_page'] = 'Item Pagina articolo';
$lang['category_page'] = 'Pagina Category';
$lang['catalog_printable'] = 'Catalogo stampabile';
$lang['catalog_datasheet'] = 'Foglio dati';
$lang['catalog_short_list'] = 'Lista feature';
$lang['title_global_item_sort_order'] = 'Configura articoli ordinati per';
$lang['title_global_items_per_page'] = 'Configura numero di articoli per pagina a';
$lang['title_global_category_recurse'] = 'Configura il comportamento della visualizzazione della categoria a';
$lang['title_item_sort_order'] = 'Ordine predefinito articoli';
$lang['title_printable_sort_order'] = 'Ordine predefinito stampa catalogo';
$lang['title_items_per_page'] = 'Numero predefinito di articoli per pagina';
$lang['title_avail_attrs'] = 'Attributi articolo utilizzabili per il Modello';
$lang['title_avail_imattrs'] = 'Immagini articolo utilizzabili per il Modello';
$lang['title_item_image_size_hero'] = 'Dimensione immagine per la pagina articolo (asse lungo in pixels)';
$lang['title_item_image_size_thumbnail'] = 'Dimensione dell&#039;immagine miniatura per la pagina articolo (asse lungo in pixels)';
$lang['title_item_image_size_category'] = 'Dimensione dell&#039;immagine miniatura per gli articoli sulla pagina categoria (asse lungo in pixels)';
$lang['title_item_image_size_catalog'] = 'Dimensione dell&#039;immagine miniatura per gli articoli sulla pagina catalogo (asse lungo in pixels)';
$lang['title_category_image_size_hero'] = 'Dimensione immagine per la pagina categoria (asse lungo in pixels)';
$lang['title_category_image_size_thumbnail'] = 'Dimensione dell&#039;immagine miniatura per la pagina categoria (asse lungo in pixels)';
$lang['title_template'] = 'Modello';
$lang['title_template_type'] = 'Tipo di Modello';
$lang['title_title'] = 'Titolo';
$lang['title_item_image_count'] = 'Massimo numero di viste per ciascun articolo';
$lang['title_category_image_count'] = 'Numero massimo di immagini Banner per ciascuna pagina di categoria';
$lang['title_item_attributes_help'] = 'Ciascun attributo inserito sar&agrave; il titolo di un campo che potete usare per descrivere un articolo individuale e sar&agrave; visualizzato con quel articolo. Dovete aggiornare il vostro Modello per riflettere questi attributi. Lasciare in bianco o inserire un attributo esistente per rimuovere o sostituire.';
$lang['title_category_attributes_help'] = 'Ciascun attributo inserito sar&agrave; il titolo di un campo che potete usare per descrivere una categoria e sar&agrave; visualizzato nella pagina categoria. Dovete aggiornare il vostro Modello per riflettere questi attributi. Lasciare in bianco o inserire un attributo esistente per rimuovere o sostituire.';
$lang['title_catalog_attributes_help'] = 'Ciascun attributo inserito sar&agrave; il titolo di un campo che potete usare per descrivere l&#039;intero catalogo e sar&agrave; visualizzato sulla pagina del catalogo stampato. Dovete aggiornare il vostro Modello per riflettere questi attributi. Lasciare in bianco o inserire un attributo esistente per rimuovere o sostituire.';
$lang['title_force_aspect_ratio'] = 'Forzo le immagini ad uno specifico rapporto delle dimensioni?';
$lang['title_force_aspect_ratio_label'] = 'Forzo il rapporto delle dimensioni (non ancora implementato)';
$lang['title_image_aspect_ratio'] = 'Rapporto delle dimensioni (specificare come &quot;4:3&quot; o &quot;1:2.5&quot;)';
$lang['title_aspect_ratio_help'] = 'Se forzate una immagine ad uno specifico rapporto delle dimensioni, allora sar&agrave; scalata per adattare esattamente a quel rapporto (o l&#039;inverso, cos&igrave; da avere entrambi i formati orrizontale e vertcale). Altrimenti, le immagini preserveranno il loro rapporto delle dimensioni e scaleranno in modo che l&#039;asse lungo &egrave; la dimensione specificata. <b>Non ancora implementato!</b>';
$lang['title_category_sort'] = 'Ordine della lista articoli nella pagina categoria';
$lang['title_category_recurse'] = 'Comportamento predefinito della visualizzazione della categoria';
$lang['title_category_recurse_items_all'] = 'Include tutti gli articoli di quella categoria, incluso gli articoli nelle sotto-categorie';
$lang['title_category_recurse_items_one'] = 'Include tutti gli articoli di quella categoria, ma non gli articoli nelle sotto-categorie';
$lang['title_category_recurse_categories_all'] = 'Include tutte le categorie di quella categoria, incluso le categorie nelle sotto-categorie';
$lang['title_category_recurse_categories_one'] = 'Include tutte le categorie di quella categoria, ma non le categorie nelle sotto-categorie';
$lang['title_category_recurse_mixed_all'] = 'Include tutti gli articoli e categorie di quella categoria, incluso gli articoli e categorie nelle sotto-categorie';
$lang['title_category_recurse_mixed_one'] = 'Include tutti gli articoli e categorie di quella categoria, ma non gli articoli e categorie nelle sotto-categorie';
$lang['title_show_missing_images'] = 'Mostra una immagine &quot;No Image&quot; per immagini mancanti';
$lang['title_show_missing_images_long'] = 'Mostra una speciale immagine &quot;No Image&quot; se ci sono immagini mancanti (altrimenti user&agrave; una immagine trasparente con un singolo pixel).';
$lang['natural_order'] = 'Ordine di navigazione';
$lang['alpha_order'] = 'Ordine alfabetico';
$lang['manageprefs'] = 'Gestione preferenze';
$lang['manageattrs'] = 'Gestione attributi definiti dall&#039;Utente';
$lang['globalops'] = 'Operazioni globali sul catalogo';
$lang['addtemplate'] = 'Aggiungi un nuovo Sotto-Modello';
$lang['reimporttemplates'] = 'Re-importa i Sotto-Modelli di esempio';
$lang['reimported'] = 'I Sotto-Modelli di esempio sono stati importati.';
$lang['templateupdated'] = 'Modello aggiunto/aggiornato.';
$lang['templatedeleted'] = 'Modello cancellato.';
$lang['prefsupdated'] = 'Preferenze aggiornate.';
...
$lang['attrsupdated'] = 'Attributi aggiornati.';
$lang['noglobalchange'] = 'Non cambiare';
$lang['globallyupdated'] = 'I cambiamenti sono stati propagati globalmente.';
$lang['edittemplate'] = 'Modifica Modello';
$lang['subtemplates'] = 'Sotto-Modelli per catalogo';
$lang['next'] = ':&amp;#187;';
$lang['prev'] = '&amp;#171;:';
$lang['edit'] = 'Modifica';
$lang['delete'] = 'Cancellazione';
$lang['notemplates'] = 'Nessun Sotto-Modello installato!';
...
$lang['postinstall'] = 'Essere sicuri di configurare il permesso &quot;Modifica configurazione Catalog&quot; agli utenti che amministreranno il catalogo.';
