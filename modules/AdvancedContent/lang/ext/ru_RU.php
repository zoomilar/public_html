<?php
$lang['AdvancedContent'] = 'Расширенное содержимое';
$lang['advancedcontent_tabname'] = 'Расширенные опции';
$lang['installed'] = 'Модуль AdvancedContent %s установлен';
$lang['uninstalled'] = 'Модуль AdvancedContent %s удален';
$lang['upgraded'] = 'Модуль AdvancedContent обновлен до %s';
$lang['postinstall'] = 'Модуль AdvancedContent %s установлен.';
$lang['postuninstall'] = 'Модуль AdvancedContent %s удален.';
$lang['confirmuninstall'] = 'Вы действительно хотите удалить модуль AdvancedContent?';
$lang['notice_duplicatecontent'] = '<em> <strong> Обратите внимание: </strong> Этот блок используется несколько раз в шаблоне. Вы видите здесь только первый блок. </em>
';
...
$lang['error_expiredate'] = 'Дата окончания должна быть позже даты начала.';
$lang['youareintext'] = 'Текущий каталог';
$lang['dimensions'] = 'Размер изображения';
$lang['size'] = 'Размер файла';
$lang['inherit_from_parent'] = 'Наследовать от родительского';
$lang['none'] = 'ничего';
$lang['invalid'] = 'неверно';
$lang['invalid_blocktype'] = '<em><strong>Обратите внимание:</strong> Неверное значение \'%s\' параметра block_type в блоке \'%s\'.<br />Проверьте ваш шаблон страницы.</em>';
$lang['error_insufficient_blockparams'] = '<em><strong>Ошибка:</strong> Недостаточно параметров. <br />Отсутствует параметр \'%s\' для блока \'%s\'. Проверьте ваш шаблон страницы.</em>';
$lang['yes'] = 'Да';
$lang['no'] = 'Нет';
$lang['frontendaccess'] = 'Frontend доступ';
$lang['redirectpage'] = 'Redirect Page, если нет доступа';
$lang['showloginform'] = 'Показать форму входа';
$lang['registeredusers'] = 'Только для зарегистрированных пользователей';
$lang['block'] = 'Блок';
$lang['useexpiredate'] = 'Использовать дату окончания';
$lang['startdate'] = 'Дата начала';
$lang['enddate'] = 'Дата окончания';
$lang['blockcontent'] = 'Блок содержимое';
$lang['setpageinactive'] = 'Установить эту страницу, как неактивную';
$lang['deletepage'] = 'Удалить страницу';
$lang['uninstallaction'] = 'Удалить действие';
$lang['setcontent1'] = 'Установить все страницы типа AdvancedContent обратно к типу Content';
$lang['setcontent2'] = 'Установить все страницы типа AdvancedContent обратно к типу Content и удалить дополнительные блоки содержимого';
$lang['prefsupdated'] = 'Настройки обновлены';
$lang['success'] = 'ОК';
$lang['error'] = 'Ошибка';
$lang['deletepages'] = 'Удалить все страницы типа AdvancedContent';
$lang['importpages'] = 'Установить все страницы типа %s к типу %s.';
$lang['pagesimported'] = 'Все содержимое страниц, установлено в AdvancedContent.';
$lang['confirmimport'] = 'Вы действительно хотите изменить тип содержимого для всех страниц?';
$lang['toggle_message'] = 'Скрыть это сообщение';
$lang['contentsettings'] = 'Настройки AdvancedContent по умолчанию';
$lang['redirectparams'] = 'добавить параметры URL при перенаправлении';
$lang['evaluatesmarty'] = 'Использовать Smarty для обработки параметров';
$lang['error_loading_module'] = '<em><strong>Ошибка:</strong> Не могу загрузить модуль \'%s\'. (Определено для блока \'%s\' в вашем шаблоне страницы.)</em>';
$lang['error_contentblock_support'] = '<em><strong>Ошибка:</strong> Модуль \'%s\' не поддерживает блоки контента. (Определено для блока \'%s\' в вашем шаблоне страницы.)</em>';
$lang['success_importpages'] = 'Все страницы типа %s успешно приведены к типу %s';
$lang['show_advancedcontent_options'] = 'Показать вкладку параметров AdvancedContent';
$lang['display_settings'] = '%s display settings';
$lang['save_collapse_status'] = 'Сохранить статус collpase для %s';
$lang['content_blocks'] = 'блоки содержимого';
$lang['block_message'] = 'содержимое блока сообщения';
$lang['block_groups'] = 'блок групп';
$lang['collapse_default'] = 'Collapse %s по умолчанию';
$lang['per_page'] = 'на страницу';
$lang['per_template'] = 'на шаблон';
$lang['both1'] = 'template OR page ';
$lang['both2'] = 'template AND page';
$lang['content'] = 'Содержимое';
$lang['content2'] = 'Расширенное содержимое';
...
$lang['input_fields'] = 'Поля ввода';
$lang['tpl_name'] = 'Имя шаблона';
$lang['error_template'] = 'Шаблон имеет необходимые поля и не может быть пустым';
...
$lang['delete_selected'] = 'Удалить выбранные элементы';
$lang['confirm_delete'] = 'Вы действительно хотите сделать удалить этот элемент?';
$lang['confirm_delete_selected'] = 'Вы действительно хотите удалить выбранные элементы?';
$lang['use_contenttype'] = 'Использовать contenttype';
...
parent pages.</p>
<p><em><strong>Notice:</strong> To get the full functionality of this content type 
in frontend you need to call your content with the module plugin {AdvancedContent} 
(case sensitive!).<br />
Otherwise it may behave like the default content type plugin.</em></p>
...
<p>Copyright © 2010, Georg Busch (NaN). All Rights Are Reserved.</p>
